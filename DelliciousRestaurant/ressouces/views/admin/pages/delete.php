<?php 
     ...
     if(isset($_GET['code']))
{
  $m = \App\App::getInstance()->getTable('plat')->findById($_GET['code']);
  if($m) {
//        var_dump($cat);die();
...
if(isset($_POST['edit']) AND !empty($_POST)) {
  ...
  $ch = \App\App::getInstance()->getTable('plat')
      ->update($m->id, [
...
?>
 ...
 <div class="card" style="width:1000px;">
                      <div class="card-header">
                        <strong>Modifier</strong> Article
                      </div>
                      <div class="card-body card-block" style=" padding-left:80px;">
                        <form action=" " method="POST" enctype="multipart/form-data" class="form-horizontal">
                         
                          <div class="row form-group">
                            <div class="col col-md-6"><label for="textarea-input" name="texte" class=" form-control-label">Detail :</label></div>
                           ...
                           <div class="row form-group">
                            ...
                            <input type="file" id="file-multiple-input" value="image" name="image" multiple="" 
